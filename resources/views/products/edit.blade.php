    ...
    <div class="col-md-6">
        <form method="post" action="{{ route('products.update', $product) }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input name="productCode" type="text" class="form-control" id="productCode"
                           aria-describedby="productCodeHelper" value="{{ $product->productCode }}" disabled>
                </div>
                @error('productCode')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input name="productName" type="text" class="form-control" id="productName"
                           aria-describedby="productNameHelper" value="{{ $product->productName }}" required>
                </div>
                @error('productName')
                <div class="col-sm-3 validation-block">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <select name="productLine" class="custom-select" id="productLine"
                            aria-describedby="productLineHelper" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <select name="productScale" class="custom-select" id="productScale"
                            aria-describedby="productScaleHelper" required>
                        <option value="{{ $product->productScale }}">{{ $product->productScale }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <select name="productVendor" class="custom-select" id="productVendor"
                            aria-describedby="productVendor" required>
                        <option value="{{ $product->productVendor }}">{{ $product->productVendor }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <textarea name="productDescription" class="form-control" id="productDescription" rows="4"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <input name="quantityInStock" type="text" class="form-control" id="quantityInStock"
                           aria-describedby="quantityHelper" value="{{ $product->quantityInStock }}" required>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <input name="buyPrice" type="text" class="form-control" id="buyPrice" aria-describedby="priceHelper"
                           value="{{ $product->buyPrice }}" required>
                </div>
                @error('buyPrice')
                <div class="col-sm-3 validation-block">
        ...
        <form action="{{ route('products.destroy', $product) }}" method="post">
            ...
            <div class="row">
                <div class="col-sm-3"></div>
                <div class="col-sm-3">
                    <button id="delete-button" type="submit" class="btn btn-warning">Delete Product</button>
                </div>
                <div class="col-sm-6">
