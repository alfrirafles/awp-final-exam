...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
    @if (Route::has('login'))
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
                <a class="account-links" href="{{ url('/home') }}" class="text-sm text-gray-700 underline">Home</a>
            @else
                <a class="account-links" href="{{ route('login') }}" class="text-sm text-gray-700 underline">Login</a>

                @if (Route::has('register'))
                    <a class="account-links" href="{{ route('register') }}"
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
            ...
            <h1 id="page-title">E-Commerce Application</h1>
        </div>
        <div class="flex items-center sm:justify-between" id="landing-menu">
            <p class="small-texts">Customer?</p>
